			...
			<div class="col">
				...
				<table width="1100" border="1">
					<form action="reply" method="post">
						<input type="hidden" name="community_id" value="${reply_view.community_id}">
						<input type="hidden" name="community_group" value="${reply_view.community_group}">
						<input type="hidden" name="community_step" value="${reply_view.community_step}">
						<input type="hidden" name="community_indent" value="${reply_view.community_indent}">
						<tr>
							<th  width="100" height="40">제목</th>
							<td><input type="text" name="community_title" size="140" value="${reply_view.community_title}"></td>
						</tr>
						<tr>
