...
<body>
	<script type="text/javascript">
		function updateReview() {
			document.myform.action = 'reviewUpdate?review_seq=<%=request.getParameter("review_seq")%>'
			document.myform.submit()
		}
		
		function deleteReview() {
			document.myform.action = 'reviewDelete?review_seq=<%=request.getParameter("review_seq")%>'
			document.myform.submit()
		}
	</script>
	<!-- ======= Header ======= -->
