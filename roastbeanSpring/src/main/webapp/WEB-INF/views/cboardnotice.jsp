		    ...
		    <div class="col">
		    	...
		    	<table class="table table-sm table-hover">
					...
					<tbody>
						...
						<c:forEach items="${boardnList }" var="dto">
						<tr>
						...
						<tr>
							...
							<c:choose>
								<c:when test="${ID == 'admin' }">
									<a href="boardwrite_view" class="btn" style="background: #F2BCBB; border: 0; padding:2px 10px; color: #fff; transition: 0.4s; border-radius: 50px;">공지하기</a>
								</c:when>
							</c:choose>
							</td>
						</tr>
